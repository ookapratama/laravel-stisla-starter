@extends('layouts.app', ['title' => 'Activites'])
                        ...
                        <div class="activities">
                            <div class="activity">
                                ...
                                <div class="activity-detail">
                                    ...
                                    <p>
                                        Have commented on the task of "<a href="#">Responsive design</a>".
                                    </p>
                                </div>
                            </div>
                            <div class="activity">
                                ...
                                <div class="activity-detail">
                                    ...
                                    <p>
                                        Moved the task "<a href="#">Fix some features that are bugs in the master
                                            module</a>" from Progress to Finish.
                                    </p>
                                </div>
                            </div>
                            <div class="activity">
                            ...
                            <div class="activity">
                                ...
                                <div class="activity-detail">
                                    ...
                                    <p>
                                        Log out of the system after 6 hours using the system.
                                    </p>
                                </div>
                            </div>
                            <div class="activity">
                            ...
                            <div class="activity">
                                ...
                                <div class="activity-detail">
                                    ...
                                    <p>
                                        Assign the task of "<a href="#">Redesigning website header and make it
                                            responsive
                                            AF</a>" to <a href="#">Syahdan Ubaidilah</a>.
                                    </p>
                                </div>
                            </div>
                        </div>
