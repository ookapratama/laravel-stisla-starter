@extends('layouts.app', ['title' => 'Components Hero'])
@section('content')
    @push('styles')
    @endpush
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-4">
                        <div class="hero text-white hero-bg-image hero-bg-parallax"
                            data-background="{{ asset('img/unsplash/andre-benz-1214056-unsplash.jpg')}}">
                            <div class="hero-inner">
                                <h2>Welcome, Ujang!</h2>
                                <p class="lead">You almost arrived, complete the information about your account to
                                    complete registration.</p>
                    ...
                    <div class="col-12 mb-4">
                        <div class="hero text-white hero-bg-image"
                            data-background="{{ asset('img/unsplash/eberhard-grossgasteiger-1207565-unsplash.jpg')}}">
                            <div class="hero-inner">
                                <h2>Welcome, Ujang!</h2>
                                <p class="lead">You almost arrived, complete the information about your account to
                                    complete registration.</p>
