@extends('layouts.app', ['title' => 'Components Gallery'])
@section('content')
    @push('styles')
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="gallery">
                                            ...
                                            <div class="gallery-item" data-image="{{ asset('img/news/img03.jpg')}}"
                                                data-title="Image 7"></div>
                                            <div class="gallery-item gallery-more" data-image="{{ asset('img/news/img02.jpg')}}"
                                                data-title="Image 8">
                                                <div>+2</div>
                                            </div>
                                            <div class="gallery-item gallery-hide" data-image="{{ asset('img/news/img11.jpg')}}"
