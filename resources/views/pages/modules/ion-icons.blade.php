@extends('layouts.app', ['title' => 'Modules > Ion Icons'])
@section('content')
    @push('styles')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul id="icons" class="ionicons">
                            ...
                            <li class="ion ion-navicon-round" data-pack="default" data-tags="menu, hamburger, slide menu">
                            </li>
                            ...
                            <li class="ion ion-checkmark-round" data-pack="default"
                                data-tags="complete, finished, success, on"></li>
                            <li class="ion ion-checkmark" data-pack="default"
                                data-tags="complete, finished, success, on"></li>
                            <li class="ion ion-checkmark-circled" data-pack="default"
                                data-tags="complete, finished, success, on"></li>
                            ...
                            <li class="ion ion-close-circled" data-pack="default" data-tags="delete, trash, kill, x">
                            </li>
                            <li class="ion ion-plus-round" data-pack="default" data-tags="add, include, new, invite, +">
                            </li>
                            <li class="ion ion-plus" data-pack="default" data-tags="add, include, new, invite, +"></li>
                            <li class="ion ion-plus-circled" data-pack="default"
                                data-tags="add, include, new, invite, +"></li>
                            <li class="ion ion-minus-round" data-pack="default" data-tags="hide, remove, minimize, -">
                            </li>
                            <li class="ion ion-minus" data-pack="default" data-tags="hide, remove, minimize, -"></li>
                            <li class="ion ion-minus-circled" data-pack="default" data-tags="hide, remove, minimize, -">
                            </li>
                            <li class="ion ion-information" data-pack="default" data-tags="help, more, tooltip"></li>
                            <li class="ion ion-information-circled" data-pack="default" data-tags="help, more, tooltip">
                            </li>
                            ...
                            <li class="ion ion-backspace-outline" data-pack="default" data-tags="delete, remove, back">
                            </li>
                            ...
                            <li class="ion ion-alert" data-pack="default"
                                data-tags="attention, warning, notice, !, exclamation"></li>
                            <li class="ion ion-alert-circled" data-pack="default"
                                data-tags="attention, warning, notice, !, exclamation"></li>
                            ...
                            <li class="ion ion-toggle-filled" data-pack="default" data-tags="settings, options, switch">
                            </li>
                            ...
                            <li class="ion ion-edit" data-pack="default" data-tags="change, update, write, type, pencil">
                            </li>
                            ...
                            <li class="ion ion-paper-airplane" data-pack="default"
                            ...
                            <li class="ion ion-clock" data-pack="default"
                                data-tags="time, watch, hours, minutes, seconds"></li>
                            <li class="ion ion-compass" data-pack="default" data-tags="location, directions, navigation">
                            </li>
                            ...
                            <li class="ion ion-person-add" data-pack="default"
                                data-tags="users, staff, head, human, member, new"></li>
                            <li class="ion ion-person-stalker" data-pack="default"
                            ...
                            <li class="ion ion-calculator" data-pack="default"
                            ...
                            <li class="ion ion-wand" data-pack="default"
                                data-tags="images, levels, light, dark, settings"></li>
                            <li class="ion ion-contrast" data-pack="default"
                                data-tags="images, levels, light, dark, settings"></li>
                            <li class="ion ion-aperture" data-pack="default"
                                data-tags="images, levels, light, dark, settings"></li>
                            <li class="ion ion-crop" data-pack="default"
                                data-tags="images, levels, light, dark, settings"></li>
                            <li class="ion ion-easel" data-pack="default" data-tags="images, art, create, color"></li>
                            <li class="ion ion-paintbrush" data-pack="default" data-tags="images, art, create, color">
                            </li>
                            <li class="ion ion-paintbucket" data-pack="default" data-tags="images, art, create, color">
                            </li>
                            ...
                            <li class="ion ion-ipad" data-pack="default"
                                data-tags="tablet, mobile, apple, retina, device"></li>
                            <li class="ion ion-iphone" data-pack="default"
                                data-tags="smartphone, mobile, apple, retina, device"></li>
                            <li class="ion ion-ipod" data-pack="default"
                            ...
                            <li class="ion ion-outlet" data-pack="default" data-tags="digital, computer, electricity">
                            </li>
                            ...
                            <li class="ion ion-code-working" data-pack="default" data-tags="develop, program, hacker">
                            </li>
                            <li class="ion ion-code-download" data-pack="default" data-tags="develop, program, hacker">
                            </li>
                            <li class="ion ion-fork-repo" data-pack="default"
                                data-tags="develop, program, hacker, github"></li>
                            <li class="ion ion-network" data-pack="default" data-tags="develop, program, hacker, github">
                            </li>
                            <li class="ion ion-pull-request" data-pack="default"
                                data-tags="develop, program, hacker, github"></li>
                            <li class="ion ion-merge" data-pack="default" data-tags="develop, program, hacker, github">
                            </li>
                            ...
                            <li class="ion ion-closed-captioning" data-pack="default"
                            ...
                            <li class="ion ion-speakerphone" data-pack="default"
                            ...
                            <li class="ion ion-levels" data-pack="default" data-tags="options, toggles, sound, mixer">
                            </li>
                            ...
                            <li class="ion ion-tshirt-outline" data-pack="default"
                                data-tags="tie, shirt, dress, clothing"></li>
                            <li class="ion ion-tshirt" data-pack="default" data-tags="tie, shirt, dress, clothing"></li>
                            <li class="ion ion-trophy" data-pack="default"
                                data-tags="competition, compete, win, lose, award"></li>
                            <li class="ion ion-podium" data-pack="default"
                                data-tags="competition, compete, win, lose, award"></li>
                            <li class="ion ion-ribbon-a" data-pack="default"
                                data-tags="competition, compete, win, lose, award, trophy"></li>
                            <li class="ion ion-ribbon-b" data-pack="default"
                                data-tags="competition, compete, win, lose, award, trophy"></li>
                            <li class="ion ion-university" data-pack="default"
                            ...
                            <li class="ion ion-erlenmeyer-flask" data-pack="default"
                            ...
                            <li class="ion ion-planet" data-pack="default"
                            ...
                            <li class="ion ion-waterdrop" data-pack="default"
                            ...
                            <li class="ion ion-no-smoking" data-pack="default"
                                data-tags="danger, warning, cigarette, cancer"></li>
                            <li class="ion ion-thermometer" data-pack="default"
                            ...
                            <li class="ion ion-model-s" data-pack="default"
                            ...
                            <li class="ion ion-ios-ionic-outline" data-pack="ios" data-tags="badass, framework, sexy">
                            </li>
                            ...
                            <li class="ion ion-ios-circle-filled" data-pack="ios"
                                data-tags="checkmark, radio, dot, on, selected, button"></li>
                            <li class="ion ion-ios-circle-outline" data-pack="ios"
                                data-tags="checkmark, radio, dot, off, button"></li>
                            <li class="ion ion-ios-checkmark-empty" data-pack="ios"
                                data-tags="success, confirmed, on, finished, complete"></li>
                            <li class="ion ion-ios-checkmark-outline" data-pack="ios"
                                data-tags="success, confirmed, on, finished, complete"></li>
                            <li class="ion ion-ios-checkmark" data-pack="ios"
                                data-tags="success, confirmed, on, finished, complete"></li>
                            <li class="ion ion-ios-plus-empty" data-pack="ios" data-tags="add, include, new, invite, +">
                            </li>
                            <li class="ion ion-ios-plus-outline" data-pack="ios"
                                data-tags="add, include, new, invite, +"></li>
                            <li class="ion ion-ios-plus" data-pack="ios" data-tags="add, include, new, invite, +"></li>
                            <li class="ion ion-ios-close-empty" data-pack="ios"
                                data-tags="delete, remove, trash, end, stop, x"></li>
                            <li class="ion ion-ios-close-outline" data-pack="ios"
                                data-tags="delete, remove, trash, end, stop, x"></li>
                            <li class="ion ion-ios-close" data-pack="ios"
                                data-tags="delete, remove, trash, end, stop, x"></li>
                            <li class="ion ion-ios-minus-empty" data-pack="ios" data-tags="hide, remove, minimize, -">
                            </li>
                            <li class="ion ion-ios-minus-outline" data-pack="ios" data-tags="hide, remove, minimize, -">
                            </li>
                            ...
                            <li class="ion ion-ios-help-outline" data-pack="ios" data-tags="question, information, ?">
                            </li>
                            <li class="ion ion-ios-help" data-pack="ios" data-tags="question, information, ?"></li>
                            <li class="ion ion-ios-search" data-pack="ios"
                                data-tags="find, seek, look, magnifying glass"></li>
                            <li class="ion ion-ios-search-strong" data-pack="ios"
                                data-tags="find, seek, look, magnifying glass"></li>
                            ...
                            <li class="ion ion-ios-cloud-outline" data-pack="ios" data-tags="storage, weather, whether">
                            </li>
                            ...
                            <li class="ion ion-ios-refresh-outline" data-pack="ios" data-tags="reload, renew, reset">
                            </li>
                            ...
                            <li class="ion ion-ios-book-outline" data-pack="ios" data-tags="favorite, read, literature">
                            </li>
                            ...
                            <li class="ion ion-ios-glasses-outline" data-pack="ios"
                            ...
                            <li class="ion ion-ios-pricetag" data-pack="ios"
                                data-tags="shopping, money, items, commerce, $"></li>
                            <li class="ion ion-ios-pricetag-outline" data-pack="ios"
                                data-tags="shopping, money, items, commerce, $"></li>
                            <li class="ion ion-ios-pricetags" data-pack="ios"
                                data-tags="shopping, money, items, commerce, $"></li>
                            <li class="ion ion-ios-pricetags-outline" data-pack="ios"
                                data-tags="shopping, money, items, commerce, $"></li>
                            <li class="ion ion-ios-cart" data-pack="ios"
                                data-tags="shopping, money, items, commerce, $"></li>
                            <li class="ion ion-ios-cart-outline" data-pack="ios"
                                data-tags="shopping, money, items, commerce, $"></li>
                            ...
                            <li class="ion ion-ios-compose-outline" data-pack="ios" data-tags="write, type, create">
                            </li>
                            <li class="ion ion-ios-trash" data-pack="ios"
                                data-tags="delete, remove, dispose, waste, basket, dump, kill"></li>
                            <li class="ion ion-ios-trash-outline" data-pack="ios"
                                data-tags="delete, remove, dispose, waste, basket, dump, kill"></li>
                            ...
                            <li class="ion ion-ios-speedometer-outline" data-pack="ios"
                            ...
                            <li class="ion ion-ios-timer-outline" data-pack="ios" data-tags="cooking, alarm, buzz">
                            </li>
                            <li class="ion ion-ios-clock" data-pack="ios"
                                data-tags="time, date, hours, minutes, seconds, watch"></li>
                            <li class="ion ion-ios-clock-outline" data-pack="ios"
                                data-tags="time, date, hours, minutes, seconds, watch"></li>
                            <li class="ion ion-ios-time" data-pack="ios"
                                data-tags="clock, watch, hour, minute, second"></li>
                            <li class="ion ion-ios-time-outline" data-pack="ios"
                                data-tags="clock, watch, hour, minute, second"></li>
                            <li class="ion ion-ios-calendar" data-pack="ios" data-tags="date, time, month, year"></li>
                            <li class="ion ion-ios-calendar-outline" data-pack="ios"
                                data-tags="date, time, month, year"></li>
                            <li class="ion ion-ios-photos" data-pack="ios" data-tags="images, stills, square"></li>
                            <li class="ion ion-ios-photos-outline" data-pack="ios" data-tags="images, stills, square">
                            </li>
                            <li class="ion ion-ios-albums" data-pack="ios" data-tags="square, boxes, slides"></li>
                            <li class="ion ion-ios-albums-outline" data-pack="ios" data-tags="square, boxes, slides">
                            </li>
                            ...
                            <li class="ion ion-ios-eye-outline" data-pack="ios" data-tags="view, see, exposed, look">
                            </li>
                            ...
                            <li class="ion ion-ios-color-wand" data-pack="ios"
                                data-tags="camera, picture, edit, magic"></li>
                            <li class="ion ion-ios-color-wand-outline" data-pack="ios"
                                data-tags="camera, picture, edit, magic"></li>
                            <li class="ion ion-ios-color-filter" data-pack="ios" data-tags="camera, picture"></li>
                            <li class="ion ion-ios-color-filter-outline" data-pack="ios" data-tags="camera, picture">
                            </li>
                            <li class="ion ion-ios-grid-view" data-pack="ios" data-tags="camera, picture"></li>
                            <li class="ion ion-ios-grid-view-outline" data-pack="ios" data-tags="camera, picture">
                            </li>
                            <li class="ion ion-ios-crop-strong" data-pack="ios" data-tags="camera, picture, edit">
                            </li>
                            ...
                            <li class="ion ion-ios-briefcase-outline" data-pack="ios" data-tags="organize, folder">
                            </li>
                            <li class="ion ion-ios-medkit" data-pack="ios"
                                data-tags="health, case, first aid, sick, disease"></li>
                            <li class="ion ion-ios-medkit-outline" data-pack="ios"
                                data-tags="health, case, first aid, sick, disease"></li>
                            <li class="ion ion-ios-medical" data-pack="ios"
                                data-tags="health, case, first aid, sick, disease"></li>
                            <li class="ion ion-ios-medical-outline" data-pack="ios"
                                data-tags="health, case, first aid, sick, disease"></li>
                            ...
                            <li class="ion ion-ios-calculator-outline" data-pack="ios" data-tags="math, arithmatic">
                            </li>
                            <li class="ion ion-ios-keypad" data-pack="ios" data-tags="type, grid, circle"></li>
                            <li class="ion ion-ios-keypad-outline" data-pack="ios" data-tags="type, grid, circle">
                            </li>
                            <li class="ion ion-ios-telephone" data-pack="ios" data-tags="oldschool, call"></li>
                            <li class="ion ion-ios-telephone-outline" data-pack="ios" data-tags="oldschool, call">
                            </li>
                            <li class="ion ion-ios-drag" data-pack="ios" data-tags="reorder, move, drag"></li>
                            <li class="ion ion-ios-location" data-pack="ios" data-tags="navigation, map, gps, pin">
                            </li>
                            <li class="ion ion-ios-location-outline" data-pack="ios"
                                data-tags="navigation, map, gps, pin"></li>
                            <li class="ion ion-ios-navigate" data-pack="ios" data-tags="location, map, gps, pin"></li>
                            <li class="ion ion-ios-navigate-outline" data-pack="ios"
                                data-tags="location, map, gps, pin"></li>
                            <li class="ion ion-ios-locked" data-pack="ios" data-tags="security, padlock, safe"></li>
                            <li class="ion ion-ios-locked-outline" data-pack="ios"
                                data-tags="security, padlock, safe"></li>
                            <li class="ion ion-ios-unlocked" data-pack="ios" data-tags="security, padlock, safe"></li>
                            <li class="ion ion-ios-unlocked-outline" data-pack="ios"
                                data-tags="security, padlock, safe"></li>
                            <li class="ion ion-ios-monitor" data-pack="ios" data-tags="thunderbolt, display, screen">
                            </li>
                            <li class="ion ion-ios-monitor-outline" data-pack="ios"
                            ...
                            <li class="ion ion-ios-game-controller-a" data-pack="ios"
                                data-tags="gaming, nintendo, play"></li>
                            <li class="ion ion-ios-game-controller-a-outline" data-pack="ios"
                                data-tags="gaming, nintendo, play"></li>
                            <li class="ion ion-ios-game-controller-b" data-pack="ios"
                                data-tags="gaming, nintendo, play"></li>
                            <li class="ion ion-ios-game-controller-b-outline" data-pack="ios"
                                data-tags="gaming, nintendo, play"></li>
                            <li class="ion ion-ios-americanfootball" data-pack="ios"
                                data-tags="nfl, games, sports, fun, play"></li>
                            <li class="ion ion-ios-americanfootball-outline" data-pack="ios"
                                data-tags="nfl, games, sports, fun, play"></li>
                            <li class="ion ion-ios-baseball" data-pack="ios"
                                data-tags="mlb, games, sports, fun, play"></li>
                            <li class="ion ion-ios-baseball-outline" data-pack="ios"
                                data-tags="mlb, games, sports, fun, play"></li>
                            <li class="ion ion-ios-basketball" data-pack="ios"
                                data-tags="nba, games, sports, fun, play"></li>
                            <li class="ion ion-ios-basketball-outline" data-pack="ios"
                                data-tags="nba, games, sports, fun, play"></li>
                            <li class="ion ion-ios-tennisball" data-pack="ios" data-tags="games, sports, fun, play">
                            </li>
                            <li class="ion ion-ios-tennisball-outline" data-pack="ios"
                                data-tags="games, sports, fun, play"></li>
                            <li class="ion ion-ios-football" data-pack="ios"
                                data-tags="mls, soccer, games, sports, fun, play"></li>
                            <li class="ion ion-ios-football-outline" data-pack="ios"
                                data-tags="mls, soccer, games, sports, fun, play"></li>
                            <li class="ion ion-ios-body" data-pack="ios"
                                data-tags="person, users, staff, head, human"></li>
                            <li class="ion ion-ios-body-outline" data-pack="ios"
                                data-tags="person, users, staff, head, human"></li>
                            <li class="ion ion-ios-person" data-pack="ios" data-tags="users, staff, head, human"></li>
                            <li class="ion ion-ios-person-outline" data-pack="ios"
                                data-tags="users, staff, head, human"></li>
                            <li class="ion ion-ios-personadd" data-pack="ios"
                                data-tags="users, staff, head, human, new, invite"></li>
                            <li class="ion ion-ios-personadd-outline" data-pack="ios"
                                data-tags="users, staff, head, human, new, invite"></li>
                            <li class="ion ion-ios-people" data-pack="ios"
                                data-tags="stalker, person, users, head, human"></li>
                            <li class="ion ion-ios-people-outline" data-pack="ios"
                                data-tags="stalker, person, users, head, human"></li>
                            <li class="ion ion-ios-musical-notes" data-pack="ios"
                                data-tags="sound, noise, listening, play"></li>
                            <li class="ion ion-ios-musical-note" data-pack="ios"
                                data-tags="sound, noise, listening, play"></li>
                            <li class="ion ion-ios-bell" data-pack="ios"
                                data-tags="right, noise, alarm, sound, music"></li>
                            <li class="ion ion-ios-bell-outline" data-pack="ios"
                                data-tags="right, noise, alarm, sound, music"></li>
                            <li class="ion ion-ios-mic" data-pack="ios" data-tags="sound, noise, speaker, talk"></li>
                            <li class="ion ion-ios-mic-outline" data-pack="ios"
                                data-tags="sound, noise, speaker, talk"></li>
                            <li class="ion ion-ios-mic-off" data-pack="ios" data-tags="sound, noise, speaker, talk">
                            </li>
                            <li class="ion ion-ios-volume-high" data-pack="ios"
                                data-tags="sound, noise, listen, music"></li>
                            <li class="ion ion-ios-volume-low" data-pack="ios"
                                data-tags="sound, noise, listen, music"></li>
                            <li class="ion ion-ios-play" data-pack="ios" data-tags="music, watch, arrow, right"></li>
                            <li class="ion ion-ios-play-outline" data-pack="ios"
                                data-tags="music, watch, arrow, right"></li>
                            <li class="ion ion-ios-pause" data-pack="ios" data-tags="music, break, hold, freeze"></li>
                            <li class="ion ion-ios-pause-outline" data-pack="ios"
                                data-tags="music, break, hold, freeze"></li>
                            <li class="ion ion-ios-recording" data-pack="ios" data-tags="film, tape, voicemail"></li>
                            <li class="ion ion-ios-recording-outline" data-pack="ios"
                                data-tags="film, tape, voicemail"></li>
                            <li class="ion ion-ios-fastforward" data-pack="ios" data-tags="next, skip, jump"></li>
                            <li class="ion ion-ios-fastforward-outline" data-pack="ios" data-tags="next, skip, jump">
                            </li>
                            <li class="ion ion-ios-rewind" data-pack="ios" data-tags="music, previous, back"></li>
                            <li class="ion ion-ios-rewind-outline" data-pack="ios" data-tags="music, previous, back">
                            </li>
                            <li class="ion ion-ios-skipbackward" data-pack="ios" data-tags="music, previous"></li>
                            <li class="ion ion-ios-skipbackward-outline" data-pack="ios" data-tags="music, previous">
                            </li>
                            ...
                            <li class="ion ion-ios-videocam-outline" data-pack="ios" data-tags="film, movie, camera">
                            </li>
                            ...
                            <li class="ion ion-ios-flask-outline" data-pack="ios" data-tags="options, mixer, liquid">
                            </li>
                            <li class="ion ion-ios-lightbulb" data-pack="ios" data-tags="idea, new, bright, aha!">
                            </li>
                            <li class="ion ion-ios-lightbulb-outline" data-pack="ios"
                                data-tags="idea, new, bright, aha!"></li>
                            <li class="ion ion-ios-wineglass" data-pack="ios"
                                data-tags="alcohol, drink, food, glass, drunk, cheers"></li>
                            <li class="ion ion-ios-wineglass-outline" data-pack="ios"
                                data-tags="alcohol, drink, food, glass, drunk, cheers"></li>
                            <li class="ion ion-ios-pint" data-pack="ios"
                                data-tags="alcohol, drink, food, beer, drunk, cheers"></li>
                            <li class="ion ion-ios-pint-outline" data-pack="ios"
                                data-tags="alcohol, drink, food, beer, drunk, cheers"></li>
                            <li class="ion ion-ios-nutrition" data-pack="ios" data-tags="health, carrot, food"></li>
                            <li class="ion ion-ios-nutrition-outline" data-pack="ios"
                                data-tags="health, carrot, food"></li>
                            <li class="ion ion-ios-flower" data-pack="ios" data-tags="nature, spring, leaf, garden">
                            </li>
                            <li class="ion ion-ios-flower-outline" data-pack="ios"
                                data-tags="nature, spring, leaf, garden"></li>
                            <li class="ion ion-ios-rose" data-pack="ios"
                                data-tags="nature, spring, leaf, garden, flower"></li>
                            <li class="ion ion-ios-rose-outline" data-pack="ios"
                                data-tags="nature, spring, leaf, garden, flower"></li>
                            <li class="ion ion-ios-paw" data-pack="ios"
                                data-tags="nature, animal, pet, outdoor, track"></li>
                            <li class="ion ion-ios-paw-outline" data-pack="ios"
                                data-tags="nature, animal, pet, outdoor, track"></li>
                            ...
                            <li class="ion ion-ios-sunny" data-pack="ios" data-tags="weather, whether, light, sky">
                            </li>
                            <li class="ion ion-ios-sunny-outline" data-pack="ios"
                                data-tags="weather, whether, light, sky"></li>
                            <li class="ion ion-ios-partlysunny" data-pack="ios"
                                data-tags="light, weather, whether, cloudy"></li>
                            <li class="ion ion-ios-partlysunny-outline" data-pack="ios"
                                data-tags="light, weather, whether, cloudy"></li>
                            <li class="ion ion-ios-cloudy" data-pack="ios" data-tags="weather, whether, overcast">
                            </li>
                            <li class="ion ion-ios-cloudy-outline" data-pack="ios"
                                data-tags="weather, whether, overcast"></li>
                            <li class="ion ion-ios-rainy" data-pack="ios" data-tags="whether, weather, water, cloud">
                            </li>
                            <li class="ion ion-ios-rainy-outline" data-pack="ios"
                                data-tags="whether, weather, water, cloud"></li>
                            <li class="ion ion-ios-thunderstorm" data-pack="ios"
                                data-tags="whether, weather, sky, lightning, rain, cloudy, overcast, storm"></li>
                            <li class="ion ion-ios-thunderstorm-outline" data-pack="ios"
                                data-tags="whether, weather, sky, lightning, rain, cloudy, overcast, storm"></li>
                            <li class="ion ion-ios-snowy" data-pack="ios"
                            ...
                            <li class="ion ion-ios-cloudy-night" data-pack="ios"
                                data-tags="weather, whether, overcast"></li>
                            <li class="ion ion-ios-cloudy-night-outline" data-pack="ios"
                                data-tags="weather, whether, overcast"></li>

                            <li class="ion ion-android-arrow-up" data-pack="android" data-tags="chevron, navigation">
                            </li>
                            <li class="ion ion-android-arrow-forward" data-pack="android"
                                data-tags="chevron, navigation"></li>
                            <li class="ion ion-android-arrow-down" data-pack="android"
                                data-tags="chevron, navigation"></li>
                            <li class="ion ion-android-arrow-back" data-pack="android"
                                data-tags="chevron, navigation"></li>
                            <li class="ion ion-android-arrow-dropup" data-pack="android"
                                data-tags="chevron, navigation"></li>
                            <li class="ion ion-android-arrow-dropup-circle" data-pack="android"
                                data-tags="chevron, navigation"></li>
                            <li class="ion ion-android-arrow-dropright" data-pack="android"
                                data-tags="chevron, navigation"></li>
                            <li class="ion ion-android-arrow-dropright-circle" data-pack="android"
                                data-tags="chevron, navigation"></li>
                            <li class="ion ion-android-arrow-dropdown" data-pack="android"
                                data-tags="chevron, navigation"></li>
                            <li class="ion ion-android-arrow-dropdown-circle" data-pack="android"
                                data-tags="chevron, navigation"></li>
                            <li class="ion ion-android-arrow-dropleft" data-pack="android"
                                data-tags="chevron, navigation"></li>
                            <li class="ion ion-android-arrow-dropleft-circle" data-pack="android"
                                data-tags="chevron, navigation"></li>
                            <li class="ion ion-android-add" data-pack="android" data-tags="plus, include, invite">
                            </li>
                            <li class="ion ion-android-add-circle" data-pack="android"
                                data-tags="plus, include, invite"></li>
                            <li class="ion ion-android-remove" data-pack="android"
                                data-tags="minus, subtract, delete"></li>
                            <li class="ion ion-android-remove-circle" data-pack="android"
                                data-tags="minus, subtract, delete"></li>
                            ...
                            <li class="ion ion-android-checkbox-outline-blank" data-pack="android" data-tags="">
                            </li>
                            ...
                            <li class="ion ion-android-more-horizontal" data-pack="android" data-tags="options, menu">
                            </li>
                            <li class="ion ion-android-more-vertical" data-pack="android" data-tags="options, menu">
                            </li>
                            ...
                            <li class="ion ion-android-wifi" data-pack="android"
                            ...
                            <li class="ion ion-android-favorite-outline" data-pack="android"
                                data-tags="favorite, like, rate"></li>
                            <li class="ion ion-android-favorite" data-pack="android" data-tags="favorite, like, rate">
                            </li>
                            <li class="ion ion-android-star-outline" data-pack="android"
                                data-tags="favorite, like, rate"></li>
                            <li class="ion ion-android-star-half" data-pack="android"
                                data-tags="favorite, like, rate"></li>
                            <li class="ion ion-android-star" data-pack="android" data-tags="favorite, like, rate">
                            </li>
                            ...
                            <li class="ion ion-android-bicycle" data-pack="android"
                            ...
                            <li class="ion ion-android-bar" data-pack="android" data-tags="wine, drink, food, dinner">
                            </li>
                            ...
                            <li class="ion ion-android-microphone" data-pack="android"
                                data-tags="recorder, speak, noise, music, sound"></li>
                            <li class="ion ion-android-microphone-off" data-pack="android"
                            ...
                            <li class="ion ion-social-twitter" data-pack="social" data-tags="follow, post, share">
                            </li>
                            <li class="ion ion-social-twitter-outline" data-pack="social"
                                data-tags="follow, post, share"></li>
                            <li class="ion ion-social-facebook" data-pack="social" data-tags="like, post, share"></li>
                            <li class="ion ion-social-facebook-outline" data-pack="social"
                                data-tags="like, post, share"></li>
                            <li class="ion ion-social-googleplus" data-pack="social" data-tags="follow, post, share">
                            </li>
                            <li class="ion ion-social-googleplus-outline" data-pack="social"
                                data-tags="follow, post, share"></li>
                            <li class="ion ion-social-google" data-pack="social" data-tags="follow, post, share"></li>
                            <li class="ion ion-social-google-outline" data-pack="social"
                                data-tags="follow, post, share"></li>
                            ...
                            <li class="ion ion-social-octocat" data-pack="social"
                                data-tags="code, github, fork, merge, clone"></li>
                            <li class="ion ion-social-github" data-pack="social" data-tags="code, fork, merge, clone">
                            </li>
                            <li class="ion ion-social-github-outline" data-pack="social"
                                data-tags="code, fork, merge, clone"></li>
                            <li class="ion ion-social-instagram" data-pack="social"
                                data-tags="photo, camera, facebook"></li>
                            <li class="ion ion-social-instagram-outline" data-pack="social"
                                data-tags="photo, camera, facebook"></li>
                            <li class="ion ion-social-whatsapp" data-pack="social"
                                data-tags="text, sharing, private, facebook"></li>
                            <li class="ion ion-social-whatsapp-outline" data-pack="social"
                                data-tags="text, sharing, private, facebook"></li>
                            <li class="ion ion-social-snapchat" data-pack="social" data-tags="photos, app"></li>
                            <li class="ion ion-social-snapchat-outline" data-pack="social" data-tags="photos, app">
                            </li>
                            ...
                            <li class="ion ion-social-reddit" data-pack="social" data-tags="news, upvotes, karma">
                            </li>
                            <li class="ion ion-social-reddit-outline" data-pack="social"
                                data-tags="news, upvotes, karma"></li>
                            <li class="ion ion-social-hackernews" data-pack="social"
                                data-tags="discuss, upvotes, karma"></li>
                            <li class="ion ion-social-hackernews-outline" data-pack="social"
                                data-tags="discuss, upvotes, karma"></li>
                            <li class="ion ion-social-designernews" data-pack="social" data-tags="design, post"></li>
                            <li class="ion ion-social-designernews-outline" data-pack="social"
                            ...
                            <li class="ion ion-social-vimeo" data-pack="social" data-tags="video, watch, share, view">
                            </li>
                            <li class="ion ion-social-vimeo-outline" data-pack="social"
                                data-tags="video, watch, share, view"></li>
                            <li class="ion ion-social-twitch" data-pack="social"
                                data-tags="gaming, games, live, streaming, video, watch, share, view"></li>
                            <li class="ion ion-social-twitch-outline" data-pack="social"
                                data-tags="gaming, games, live, streaming, video, watch, share, view"></li>
                            <li class="ion ion-social-youtube" data-pack="social"
                                data-tags="video, watch, share, view"></li>
                            <li class="ion ion-social-youtube-outline" data-pack="social"
                                data-tags="video, watch, share, view"></li>
                            ...
                            <li class="ion ion-social-html5" data-pack="social"
                                data-tags="code, html, css, js, developer"></li>
                            <li class="ion ion-social-html5-outline" data-pack="social"
                                data-tags="code, html, css, js, developer"></li>
                            <li class="ion ion-social-css3" data-pack="social"
                                data-tags="code, html, css, js, developer"></li>
                            <li class="ion ion-social-css3-outline" data-pack="social"
                                data-tags="code, html, css, js, developer"></li>
                            <li class="ion ion-social-javascript" data-pack="social"
                                data-tags="code, html, css, js, developer"></li>
                            <li class="ion ion-social-javascript-outline" data-pack="social"
                                data-tags="code, html, css, js, developer"></li>
                            <li class="ion ion-social-angular" data-pack="social"
                                data-tags="code, mobile, js, angularjs, ionic"></li>
                            <li class="ion ion-social-angular-outline" data-pack="social"
                                data-tags="code, mobile, js, angularjs, ionic"></li>
                            <li class="ion ion-social-nodejs" data-pack="social"
                            ...
                            <li class="ion ion-social-chrome" data-pack="social"
                                data-tags="code, mobile, js, angularjs, ionic"></li>
                            <li class="ion ion-social-chrome-outline" data-pack="social"
                                data-tags="code, mobile, js, angularjs, ionic"></li>
                            <li class="ion ion-social-codepen" data-pack="social" data-tags="testing, js, developer">
                            </li>
                            <li class="ion ion-social-codepen-outline" data-pack="social"
                                data-tags="testing, js, developer"></li>
                            <li class="ion ion-social-markdown" data-pack="social"
                                data-tags="code, testing, text, developer"></li>
                            <li class="ion ion-social-tux" data-pack="social" data-tags="code, linux, opensource">
                            </li>
                            <li class="ion ion-social-freebsd-devil" data-pack="social"
                                data-tags="code, opensource, unix"></li>
                            <li class="ion ion-social-usd" data-pack="social"
                                data-tags="currency, trade, money, cash"></li>
                            <li class="ion ion-social-usd-outline" data-pack="social"
                                data-tags="currency, trade, money, cash"></li>
                            <li class="ion ion-social-bitcoin" data-pack="social" data-tags="currency, trade, money">
                            </li>
                            <li class="ion ion-social-bitcoin-outline" data-pack="social"
                                data-tags="currency, trade, money"></li>
                            <li class="ion ion-social-yen" data-pack="social"
                                data-tags="currency, trade, money, japanese"></li>
                            <li class="ion ion-social-yen-outline" data-pack="social"
                                data-tags="currency, trade, money, japanese"></li>
                            <li class="ion ion-social-euro" data-pack="social"
                                data-tags="currency, trade, money, europe"></li>
                            <li class="ion ion-social-euro-outline" data-pack="social"
                                data-tags="currency, trade, money, europe"></li>
                        </ul>
                    </div>
                </div>
