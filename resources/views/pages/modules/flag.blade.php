@extends('layouts.app', ['title' => 'Modules > Flag'])
@section('content')
    @push('styles')
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="country" data-name="Afghanistan" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/af.svg')}}" alt="Afghanistan Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Aland Islands" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ax.svg')}}" alt="Aland Islands Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Albania" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/al.svg')}}" alt="Albania Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Algeria" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/dz.svg')}}" alt="Algeria Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="American Samoa" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/as.svg')}}" alt="American Samoa Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Andorra" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ad.svg')}}" alt="Andorra Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Angola" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ao.svg')}}" alt="Angola Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Anguilla" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ai.svg')}}" alt="Anguilla Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Antigua and Barbuda" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ag.svg')}}" alt="Antigua and Barbuda Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Argentina" data-continent="South America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ar.svg')}}" alt="Argentina Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Armenia" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/am.svg')}}" alt="Armenia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Aruba" data-continent="South America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/aw.svg')}}" alt="Aruba Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Australia" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/au.svg')}}" alt="Australia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Austria" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/at.svg')}}" alt="Austria Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Azerbaijan" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/az.svg')}}" alt="Azerbaijan Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Bahamas" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/bs.svg')}}" alt="Bahamas Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Bahrain" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/bh.svg')}}" alt="Bahrain Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Bangladesh" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/bd.svg')}}" alt="Bangladesh Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Barbados" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/bb.svg')}}" alt="Barbados Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Belarus" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/by.svg')}}" alt="Belarus Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Belgium" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/be.svg')}}" alt="Belgium Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Belize" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/bz.svg')}}" alt="Belize Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Benin" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/bj.svg')}}" alt="Benin Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Bermuda" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/bm.svg')}}" alt="Bermuda Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Bhutan" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/bt.svg')}}" alt="Bhutan Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Bolivia (Plurinational State of)" data-continent="South America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/bo.svg')}}" alt="Bolivia (Plurinational State of) Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Bonaire, Sint Eustatius and Saba" data-continent="South America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/bq.svg')}}" alt="Bonaire, Sint Eustatius and Saba Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Bosnia and Herzegovina" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ba.svg')}}" alt="Bosnia and Herzegovina Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Botswana" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/bw.svg')}}" alt="Botswana Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Brazil" data-continent="South America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/br.svg')}}" alt="Brazil Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="British Indian Ocean Territory" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/io.svg')}}" alt="British Indian Ocean Territory Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Brunei Darussalam" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/bn.svg')}}" alt="Brunei Darussalam Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Bulgaria" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/bg.svg')}}" alt="Bulgaria Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Burkina Faso" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/bf.svg')}}" alt="Burkina Faso Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Burundi" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/bi.svg')}}" alt="Burundi Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Cabo Verde" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/cv.svg')}}" alt="Cabo Verde Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Cambodia" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/kh.svg')}}" alt="Cambodia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Cameroon" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/cm.svg')}}" alt="Cameroon Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Canada" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ca.svg')}}" alt="Canada Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Cayman Islands" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ky.svg')}}" alt="Cayman Islands Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Central African Republic" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/cf.svg')}}" alt="Central African Republic Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Chad" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/td.svg')}}" alt="Chad Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Chile" data-continent="South America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/cl.svg')}}" alt="Chile Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="China" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/cn.svg')}}" alt="China Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Christmas Island" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/cx.svg')}}" alt="Christmas Island Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Cocos (Keeling) Islands" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/cc.svg')}}" alt="Cocos (Keeling) Islands Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Colombia" data-continent="South America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/co.svg')}}" alt="Colombia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Comoros" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/km.svg')}}" alt="Comoros Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Cook Islands" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ck.svg')}}" alt="Cook Islands Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Costa Rica" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/cr.svg')}}" alt="Costa Rica Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Croatia" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/hr.svg')}}" alt="Croatia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Cuba" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/cu.svg')}}" alt="Cuba Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Curaçao" data-continent="South America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/cw.svg')}}" alt="Curaçao Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Cyprus" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/cy.svg')}}" alt="Cyprus Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Czech Republic" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/cz.svg')}}" alt="Czech Republic Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Côte d&#39;Ivoire" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ci.svg')}}" alt="Côte d&#39;Ivoire Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Democratic Republic of the Congo" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/cd.svg')}}" alt="Democratic Republic of the Congo Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Denmark" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/dk.svg')}}" alt="Denmark Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Djibouti" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/dj.svg')}}" alt="Djibouti Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Dominica" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/dm.svg')}}" alt="Dominica Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Dominican Republic" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/do.svg')}}" alt="Dominican Republic Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Ecuador" data-continent="South America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ec.svg')}}" alt="Ecuador Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Egypt" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/eg.svg')}}" alt="Egypt Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="El Salvador" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/sv.svg')}}" alt="El Salvador Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Equatorial Guinea" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/gq.svg')}}" alt="Equatorial Guinea Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Eritrea" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/er.svg')}}" alt="Eritrea Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Estonia" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ee.svg')}}" alt="Estonia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Ethiopia" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/et.svg')}}" alt="Ethiopia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Falkland Islands" data-continent="South America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/fk.svg')}}" alt="Falkland Islands Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Faroe Islands" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/fo.svg')}}" alt="Faroe Islands Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Federated States of Micronesia" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/fm.svg')}}" alt="Federated States of Micronesia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Fiji" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/fj.svg')}}" alt="Fiji Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Finland" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/fi.svg')}}" alt="Finland Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Former Yugoslav Republic of Macedonia" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/mk.svg')}}" alt="Former Yugoslav Republic of Macedonia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="France" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/fr.svg')}}" alt="France Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="French Guiana" data-continent="South America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/gf.svg')}}" alt="French Guiana Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="French Polynesia" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/pf.svg')}}" alt="French Polynesia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="French Southern Territories" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/tf.svg')}}" alt="French Southern Territories Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Gabon" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ga.svg')}}" alt="Gabon Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Gambia" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/gm.svg')}}" alt="Gambia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Georgia" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ge.svg')}}" alt="Georgia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Germany" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/de.svg')}}" alt="Germany Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Ghana" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/gh.svg')}}" alt="Ghana Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Gibraltar" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/gi.svg')}}" alt="Gibraltar Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Greece" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/gr.svg')}}" alt="Greece Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Greenland" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/gl.svg')}}" alt="Greenland Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Grenada" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/gd.svg')}}" alt="Grenada Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Guadeloupe" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/gp.svg')}}" alt="Guadeloupe Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Guam" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/gu.svg')}}" alt="Guam Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Guatemala" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/gt.svg')}}" alt="Guatemala Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Guernsey" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/gg.svg')}}" alt="Guernsey Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Guinea" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/gn.svg')}}" alt="Guinea Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Guinea-Bissau" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/gw.svg')}}" alt="Guinea-Bissau Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Guyana" data-continent="South America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/gy.svg')}}" alt="Guyana Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Haiti" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ht.svg')}}" alt="Haiti Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Holy See" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/va.svg')}}" alt="Holy See Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Honduras" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/hn.svg')}}" alt="Honduras Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Hong Kong" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/hk.svg')}}" alt="Hong Kong Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Hungary" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/hu.svg')}}" alt="Hungary Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Iceland" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/is.svg')}}" alt="Iceland Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="India" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/in.svg')}}" alt="India Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Indonesia" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/id.svg')}}" alt="Indonesia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Iran (Islamic Republic of)" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ir.svg')}}" alt="Iran (Islamic Republic of) Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Iraq" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/iq.svg')}}" alt="Iraq Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Ireland" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ie.svg')}}" alt="Ireland Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Isle of Man" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/im.svg')}}" alt="Isle of Man Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Israel" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/il.svg')}}" alt="Israel Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Italy" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/it.svg')}}" alt="Italy Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Jamaica" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/jm.svg')}}" alt="Jamaica Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Japan" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/jp.svg')}}" alt="Japan Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Jersey" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/je.svg')}}" alt="Jersey Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Jordan" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/jo.svg')}}" alt="Jordan Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Kazakhstan" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/kz.svg')}}" alt="Kazakhstan Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Kenya" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ke.svg')}}" alt="Kenya Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Kiribati" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ki.svg')}}" alt="Kiribati Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Kuwait" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/kw.svg')}}" alt="Kuwait Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Kyrgyzstan" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/kg.svg')}}" alt="Kyrgyzstan Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Laos" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/la.svg')}}" alt="Laos Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Latvia" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/lv.svg')}}" alt="Latvia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Lebanon" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/lb.svg')}}" alt="Lebanon Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Lesotho" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ls.svg')}}" alt="Lesotho Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Liberia" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/lr.svg')}}" alt="Liberia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Libya" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ly.svg')}}" alt="Libya Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Liechtenstein" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/li.svg')}}" alt="Liechtenstein Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Lithuania" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/lt.svg')}}" alt="Lithuania Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Luxembourg" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/lu.svg')}}" alt="Luxembourg Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Macau" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/mo.svg')}}" alt="Macau Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Madagascar" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/mg.svg')}}" alt="Madagascar Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Malawi" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/mw.svg')}}" alt="Malawi Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Malaysia" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/my.svg')}}" alt="Malaysia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Maldives" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/mv.svg')}}" alt="Maldives Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Mali" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ml.svg')}}" alt="Mali Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Malta" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/mt.svg')}}" alt="Malta Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Marshall Islands" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/mh.svg')}}" alt="Marshall Islands Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Martinique" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/mq.svg')}}" alt="Martinique Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Mauritania" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/mr.svg')}}" alt="Mauritania Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Mauritius" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/mu.svg')}}" alt="Mauritius Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Mayotte" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/yt.svg')}}" alt="Mayotte Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Mexico" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/mx.svg')}}" alt="Mexico Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Moldova" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/md.svg')}}" alt="Moldova Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Monaco" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/mc.svg')}}" alt="Monaco Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Mongolia" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/mn.svg')}}" alt="Mongolia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Montenegro" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/me.svg')}}" alt="Montenegro Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Montserrat" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ms.svg')}}" alt="Montserrat Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Morocco" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ma.svg')}}" alt="Morocco Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Mozambique" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/mz.svg')}}" alt="Mozambique Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Myanmar" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/mm.svg')}}" alt="Myanmar Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Namibia" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/na.svg')}}" alt="Namibia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Nauru" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/nr.svg')}}" alt="Nauru Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Nepal" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/np.svg')}}" alt="Nepal Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Netherlands" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/nl.svg')}}" alt="Netherlands Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="New Caledonia" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/nc.svg')}}" alt="New Caledonia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="New Zealand" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/nz.svg')}}" alt="New Zealand Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Nicaragua" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ni.svg')}}" alt="Nicaragua Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Niger" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ne.svg')}}" alt="Niger Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Nigeria" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ng.svg')}}" alt="Nigeria Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Niue" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/nu.svg')}}" alt="Niue Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Norfolk Island" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/nf.svg')}}" alt="Norfolk Island Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="North Korea" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/kp.svg')}}" alt="North Korea Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Northern Mariana Islands" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/mp.svg')}}" alt="Northern Mariana Islands Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Norway" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/no.svg')}}" alt="Norway Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Oman" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/om.svg')}}" alt="Oman Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Pakistan" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/pk.svg')}}" alt="Pakistan Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Palau" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/pw.svg')}}" alt="Palau Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Panama" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/pa.svg')}}" alt="Panama Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Papua New Guinea" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/pg.svg')}}" alt="Papua New Guinea Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Paraguay" data-continent="South America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/py.svg')}}" alt="Paraguay Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Peru" data-continent="South America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/pe.svg')}}" alt="Peru Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Philippines" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ph.svg')}}" alt="Philippines Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Pitcairn" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/pn.svg')}}" alt="Pitcairn Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Poland" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/pl.svg')}}" alt="Poland Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Portugal" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/pt.svg')}}" alt="Portugal Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Puerto Rico" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/pr.svg')}}" alt="Puerto Rico Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Qatar" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/qa.svg')}}" alt="Qatar Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Republic of the Congo" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/cg.svg')}}" alt="Republic of the Congo Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Romania" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ro.svg')}}" alt="Romania Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Russia" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ru.svg')}}" alt="Russia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Rwanda" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/rw.svg')}}" alt="Rwanda Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Réunion" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/re.svg')}}" alt="Réunion Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Saint Barthélemy" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/bl.svg')}}" alt="Saint Barthélemy Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Saint Helena, Ascension and Tristan da Cunha" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/sh.svg')}}" alt="Saint Helena, Ascension and Tristan da Cunha Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Saint Kitts and Nevis" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/kn.svg')}}" alt="Saint Kitts and Nevis Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Saint Lucia" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/lc.svg')}}" alt="Saint Lucia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Saint Martin" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/mf.svg')}}" alt="Saint Martin Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Saint Pierre and Miquelon" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/pm.svg')}}" alt="Saint Pierre and Miquelon Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Saint Vincent and the Grenadines" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/vc.svg')}}" alt="Saint Vincent and the Grenadines Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Samoa" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ws.svg')}}" alt="Samoa Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="San Marino" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/sm.svg')}}" alt="San Marino Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Sao Tome and Principe" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/st.svg')}}" alt="Sao Tome and Principe Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Saudi Arabia" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/sa.svg')}}" alt="Saudi Arabia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Senegal" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/sn.svg')}}" alt="Senegal Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Serbia" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/rs.svg')}}" alt="Serbia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Seychelles" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/sc.svg')}}" alt="Seychelles Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Sierra Leone" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/sl.svg')}}" alt="Sierra Leone Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Singapore" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/sg.svg')}}" alt="Singapore Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Sint Maarten" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/sx.svg')}}" alt="Sint Maarten Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Slovakia" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/sk.svg')}}" alt="Slovakia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Slovenia" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/si.svg')}}" alt="Slovenia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Solomon Islands" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/sb.svg')}}" alt="Solomon Islands Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Somalia" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/so.svg')}}" alt="Somalia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="South Africa" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/za.svg')}}" alt="South Africa Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="South Georgia and the South Sandwich Islands" data-continent="Antarctica">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/gs.svg')}}" alt="South Georgia and the South Sandwich Islands Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="South Korea" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/kr.svg')}}" alt="South Korea Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="South Sudan" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ss.svg')}}" alt="South Sudan Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Spain" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/es.svg')}}" alt="Spain Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Sri Lanka" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/lk.svg')}}" alt="Sri Lanka Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="State of Palestine" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ps.svg')}}" alt="State of Palestine Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Sudan" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/sd.svg')}}" alt="Sudan Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Suriname" data-continent="South America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/sr.svg')}}" alt="Suriname Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Svalbard and Jan Mayen" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/sj.svg')}}" alt="Svalbard and Jan Mayen Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Swaziland" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/sz.svg')}}" alt="Swaziland Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Sweden" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/se.svg')}}" alt="Sweden Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Switzerland" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ch.svg')}}" alt="Switzerland Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Syrian Arab Republic" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/sy.svg')}}" alt="Syrian Arab Republic Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Taiwan" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/tw.svg')}}" alt="Taiwan Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Tajikistan" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/tj.svg')}}" alt="Tajikistan Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Tanzania" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/tz.svg')}}" alt="Tanzania Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Thailand" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/th.svg')}}" alt="Thailand Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Timor-Leste" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/tl.svg')}}" alt="Timor-Leste Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Togo" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/tg.svg')}}" alt="Togo Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Tokelau" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/tk.svg')}}" alt="Tokelau Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Tonga" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/to.svg')}}" alt="Tonga Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Trinidad and Tobago" data-continent="South America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/tt.svg')}}" alt="Trinidad and Tobago Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Tunisia" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/tn.svg')}}" alt="Tunisia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Turkey" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/tr.svg')}}" alt="Turkey Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Turkmenistan" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/tm.svg')}}" alt="Turkmenistan Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Turks and Caicos Islands" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/tc.svg')}}" alt="Turks and Caicos Islands Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Tuvalu" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/tv.svg')}}" alt="Tuvalu Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Uganda" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ug.svg')}}" alt="Uganda Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Ukraine" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ua.svg')}}" alt="Ukraine Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="United Arab Emirates" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ae.svg')}}" alt="United Arab Emirates Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="United Kingdom" data-continent="Europe">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/gb.svg')}}" alt="United Kingdom Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="United States Minor Outlying Islands" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/um.svg')}}" alt="United States Minor Outlying Islands Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="United States of America" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/us.svg')}}" alt="United States of America Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Uruguay" data-continent="South America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/uy.svg')}}" alt="Uruguay Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Uzbekistan" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/uz.svg')}}" alt="Uzbekistan Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Vanuatu" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/vu.svg')}}" alt="Vanuatu Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Venezuela (Bolivarian Republic of)" data-continent="South America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ve.svg')}}" alt="Venezuela (Bolivarian Republic of) Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Vietnam" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/vn.svg')}}" alt="Vietnam Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Virgin Islands (British)" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/vg.svg')}}" alt="Virgin Islands (British) Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Virgin Islands (U.S.)" data-continent="North America">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/vi.svg')}}" alt="Virgin Islands (U.S.) Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Wallis and Futuna" data-continent="Oceania">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/wf.svg')}}" alt="Wallis and Futuna Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Western Sahara" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/eh.svg')}}" alt="Western Sahara Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Yemen" data-continent="Asia">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/ye.svg')}}" alt="Yemen Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Zambia" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/zm.svg')}}" alt="Zambia Flag">
                    </div>
                    </div>
                    <div class="col-6 col-md-3 col-lg-2 mb-5">
                    <div class="country" data-name="Zimbabwe" data-continent="Africa">
                      ...
                      <img class="img-fluid" src="{{ asset('library/flag-icon-css/flags/4x3/zw.svg')}}" alt="Zimbabwe Flag">
                    </div>
                    </div>
                  </div>
                </div>
