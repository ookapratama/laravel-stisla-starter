@extends('layouts.app', ['title' => 'Goolge Maps > Advanced Route'])
@section('content')
    @push('styles')
    @endpush
        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <p class="section-lead">
                    The same as the 'route' example, but in this example it will be a bit cooler. Click the 'Start Travel'
                    button to start seeing magic.
                </p>
    ...
    @push('scripts')
        ...
        <script src="{{ asset('js/page/gmaps-advanced-route.js') }}"></script>
    @endpush
@endsection
