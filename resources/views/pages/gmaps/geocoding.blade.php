@extends('layouts.app', ['title' => 'Google Maps > Geocoding'])
@section('content')
    @push('styles')
    @endpush
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-info">
                                    You can type the destination address in the form above then the marker will appear on
                                    the map according to your address.
                                </div>
    ...
    @push('scripts')
        ...
        <script src="{{ asset('js/page/gmaps-geocoding.js') }}"></script>
    @endpush
@endsection
