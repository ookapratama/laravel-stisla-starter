@extends('layouts.app', ['title' => 'Google Maps > Geolocation'])
@section('content')
    @push('styles')
    @endpush
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="alert alert-info">
                                    In this example there will be a marker on the map located in accordance with your
                                    position. Click 'allow' in the popup that appears in your browser.
                                </div>
    ...
    @push('scripts')
        ...
        <script src="{{ asset('js/page/gmaps-geolocation.js') }}"></script>
    @endpush
@endsection
