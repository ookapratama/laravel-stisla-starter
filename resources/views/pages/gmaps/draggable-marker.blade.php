@extends('layouts.app', ['title' => 'Google Maps > Draggable Marker'])
@section('content')
    @push('styles')
    @endpush
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-info">
                                    You can drag the marker, change the value of longitude and latitude at the above input
                                    and click on the desired position on the map to change the position of the marker.
                                </div>
    ...
    @push('scripts')
        ...
        <script src="{{ asset('js/page/gmaps-draggable-marker.js') }}"></script>
    @endpush
@endsection
